    ...
    return  (
      <div className="md:p-5 w-full max-w-3xl mx-auto pt-20">
        ...
        <div className="text-center mb-8 ">
          <h1 className="text-2xl md:text-5xl font-bold mb-8">{post.hasOwnProperty("id") ? "Edit your Confession" : "Confess"}</h1>
            <p>
             By following these simple <Link href="/About" legacyBehavior><a className="text-blue-600">guidelines</a></Link>, we can ensure that everyone feels comfortable.
            </p>
        </div>
